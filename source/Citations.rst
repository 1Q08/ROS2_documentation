...
如果你在工作中使用了 ROS 2，请引用 2022 年发表在 Science Robotics 上的论文 `Robot Operating System 2: Design, architecture, and uses in the wild <https://www.science.org/doi/10.1126/scirobotics.abm6074>`_。
...
如果你在工作中使用了 ROS 2 组合（Composition），请引用 2023 年发表在 IEEE RA-L 上的论文 `Impact of ROS 2 Node Composition in Robotic Systems <https://arxiv.org/abs/2305.09933>`_。
